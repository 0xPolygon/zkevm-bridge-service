...
func (_m *StorageCompressedInterface) BeginDBTransaction(ctx context.Context) (interface{}, error) {
	ret := _m.Called(ctx)
...
func (_c *StorageCompressedInterface_BeginDBTransaction_Call) Return(_a0 interface{}, _a1 error) *StorageCompressedInterface_BeginDBTransaction_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageCompressedInterface_BeginDBTransaction_Call) RunAndReturn(run func(context.Context) (interface{}, error)) *StorageCompressedInterface_BeginDBTransaction_Call {
	_c.Call.Return(run)
	return _c
}
