...
const (
	// GlobalExitRootsOrder identifies a GlobalExitRoot event and UpdateHashChainValue event
	GlobalExitRootsOrder EventOrder = "GlobalExitRoot"
	// RemoveL2GEROrder identifies the UpdateRemovalHashChainValue event
